                            ...
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group custom-form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="kategori_id" data-toggle="dropdown" class="form-control">
                                                ...
                                                <option value="Soğuk içecekler">Soğuk İçecekler</option>
                                                <option value="Tatlılar">Tatlılar</option>
                                                <option value="Tatlılar">Makarnalar</option>
                                                <option value="Yiyecekler">Fast-Food</option>
                                                <option value="Yiyecekler">Tavuklu Menüler</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    if ($kategori_id == "Sıcak içecekler") {
                                        ...
                                        $kategori_id = 3;
                                    } else if ($kategori_id == "Makarnalar") {
                                        $kategori_id = 4;
                                    } else if ($kategori_id == "Fast-Food") {
                                        $kategori_id = 5;
                                    } else if ($kategori_id == "Tavuklu Menüler") {
                                        $kategori_id = 6;
                                    }
                                    ...
                                    if (isset($_FILES["urun_resim"]) && $_FILES["urun_resim"]["error"] == 0) {
                                        ...
                                        if ($urun_resim_data !== false) {
                                            ...
                                            $sql = "INSERT INTO uruntablo (urun_ad, kategori_id, urun_fiyat, urun_resim_data, urun_stok,urun_detay) VALUES (?, ?, ?, CONVERT(varbinary(max), ?), ?, ?)";

                                            // Sorguyu hazırla
                                            $params = array(&$urun_ad, &$kategori_id, &$urun_fiyat, &$urun_resim_data, &$urun_stok, $urun_detay);
                                            ...
                                            if ($stmt) {
                                                ...
                                                if ($result) {
                                                    ...
                                                    echo '<script>alert("Hata: ' . print_r(sqlsrv_errors(), true) . '");</script>';
                                                }
                                            } else {
                                                echo '<script>alert("Sorgu hazırlanırken hata oluştu.");</script>';
                                            }
                                        } else {
