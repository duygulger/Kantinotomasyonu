(function($) {
  ...
  function editUrun(urunId) {
    // Düzenleme işlemlerini gerçekleştirmek için gerekli kodu buraya ekleyin
    // urunId parametresi, düzenlenecek ürünün kimliğini belirtir
    // Örneğin, bir düzenleme formunu görüntülemek için veya AJAX isteği göndermek için kullanabilirsiniz
    console.log("Ürün düzenleme işlemi: " + urunId);
  }

  function confirmDelete(urunId) {
    if (confirm("Bu ürünü silmek istediğinizden emin misiniz?")) {
      // Silme işlemlerini gerçekleştirmek için gerekli kodu buraya ekleyin
      // urunId parametresi, silinecek ürünün kimliğini belirtir
      // Örneğin, AJAX isteği göndermek veya sayfayı yeniden yüklemek için kullanabilirsiniz
      console.log("Ürün silme işlemi: " + urunId);
    }
  }
