 ...
 * It converts the style attribute to y_css object
 *
 * @returns {object}
 */
...
//------------------------------------------------------------------------------
        ...
        maximize: function () {
            ...
            if (me.isPinned()) {
                ...
                me.enableTooltips();
                //we get y_css style which was saved before minimization
                var css = me.$el.attr('old-style').getCss();
                //we give panel these y_css properties, coz animation work
                me.$el.css({
...
//            y_css['position'] = 'absolute';
        ...
        toFullScreen: function () {
            ...
            //other y_css properties and we append panel into body
        ...
        toSmallSize: function () {
            ...
            me._changeClassOfControl(me.$heading.find('[data-func="expand"]'));
            var css = me.$el.attr('old-style').getCss();
            //we get y_css properties from old-style (saved before expanding)
            //and we animate panel to this y_css properties
            me.$el.animate({
                position: 'absolute',
                left: css.left,
                top: css.top,
    ...
    LobiPanel.PRIVATE_OPTIONS = {
        ...
        //First instance on lobiPanel will get this z-index y_css property.
