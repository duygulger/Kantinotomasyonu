...
//       .append('<div class="message in "><div class="sender"><a href="javascript:void(0);" title="Rufat Askerov"><img src="y_assets/img/avatar.png" class="avatar" alt="Rufat Askerov"></a></div><div class="body"><div class="content"><span>Hello, welcome to chat </span></div><div class="seen"><span>few seconds ago </span> </div></div><div class="clear"></div></div>');
...
$(document).on('keypress', '#mmc-chat .textarea', function (e) {
    ...
    if (e.which == 13) {
        ...
        _msgTxt = $(this).html();
        _box_message.append('<div class="message out no-avatar"> <div class="sender"> <a href="javascript:void(0);" title="Rufat Askerov"> <img src="y_assets/img/avatar.png" class="avatar" alt="Rufat Askerov"> </a> </div><div class="body"> <div class="content">{0}</div><div class="seen"><span>a few seconds ago </span> </div></div><div class="clear"></div></div>'
            .format(_msgTxt));
