                                    ...
                                    <div class="user-profile">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="user-Location"><i class="ti-location-pin"></i> Dhaka, dewas</div>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane active" id="1">
                                                            <div class="contact-information">
                                                                ...
                                                                <div class="website-content">
                                                                    ...
                                                                    <span class="contact-website">www.example.com</span>
                                                                </div>
                                                                <div class="skype-content">
                                                                    <span class="contact-title">Skype:</span>
                                                                    <span class="contact-skype">support@example.com</span>
                                                                </div>
                                                            </div>
                            ...
                            <div class="card alert">
                                ...
                                <div class="recent-comment">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Mr. Akshy</h4>
                                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. </p>
                                            <div class="comment-action">
                                    ...
                                    <div class="media no-border">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Mr. Farhan</h4>
                                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. </p>
                                            <div class="comment-action">
